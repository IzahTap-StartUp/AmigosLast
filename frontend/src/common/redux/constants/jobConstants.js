...
export const JOB_CATEGORY_LIST_SUCCESS = 'JOB_CATEGORY_LIST_SUCCESS';
export const JOB_CATEGORY_LIST_REQUEST = 'JOB_CATEGORY_LIST_REQUEST';
export const JOB_CATEGORY_LIST_FAIL = 'JOB_CATEGORY_LIST_FAIL';
