...
export const sellerBookListReducer = (
    state = {loading: true, sellerBooks: []},
    action
) => {

    switch (action.type) {
        case SELLER_BOOK_LIST_REQUEST:

            return {loading: true};
        case SELLER_BOOK_LIST_SUCCESS:
            return {loading: false, sellerBooks: action.payload};
        case SELLER_BOOK_LIST_FAIL:
            return {loading: false, error: action.payload};
        default:
            return state;
    }
